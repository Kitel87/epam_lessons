    ...
    def lendBook(self, book, user):
        if book in booksList:
            if book not in self.lendDict.keys():
                ...
                print('Book has been lended. Dtabase updated.')
            else:
                print(f'Book is already being used by {self.lendDict[book]}')
        else:
            print("Apoligies! We don't have this book in our library") 
...
if __name__=='__main__':
    booksList = []
    databaseName = input('Enter the name of the databse with extension:')
